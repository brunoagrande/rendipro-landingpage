...
export const PRICING_PLANS = [
    // ─── MENSAIS ─────────────────────────────────────────────────────────
    {
        ...
        nome_curto: 'Starter',
        slug: 'starter-mensal',
        descricao: 'Cronograma, flashcards e questões completos — ideal pra quem não precisa de correção de redação ainda.',
        tipo: 'mensal',
        preco_centavos: 2490,
        redacoes_por_mes: 0,
        duracao_meses: 1,
    ...
    // ─── ANUAIS ──────────────────────────────────────────────────────────
    {
        ...
        nome_curto: 'Starter',
        slug: 'starter-anual',
        descricao: 'Cronograma, flashcards e questões completos por um ano — ideal pra quem não precisa de correção de redação ainda.',
        tipo: 'anual',
