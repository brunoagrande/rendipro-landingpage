...
const features = [
    ...
    },
    {
        ...
        description: 'Treine com a realidade da sua prova e veja seu histórico de desempenho detalhado.',
        icon: ClipboardCheck,
    ...
    },
    {
        ...
        description: 'Gráficos e estatísticas poderosas para identificar e corrigir seus pontos fracos rapidamente.',
        icon: LineChart,
    ...
    },
    {
        ...
        description: 'Interface limpa e intuitiva projetada para reduzir sua ansiedade e aumentar seu rendimento.',
        icon: Target,
        color: 'text-rose-400',
        bg: 'bg-rose-500/10',
    },
